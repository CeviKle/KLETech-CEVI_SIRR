...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--vgg_layer', type=int, default=35, help='vgg layer of unaligned loss')
        ...
        self.parser.add_argument('--lambda_gan', type=float, default=0.015, help='weight for gan loss')
        self.parser.add_argument('--lambda_vgg', type=float, default=0.15, help='weight for vgg loss')
        self.parser.add_argument('--weight_loss',type=float,default=0.35,help='weight fot overall loss')
